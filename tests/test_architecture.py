...
class ArchitectureTests(unittest.TestCase):
    ...
    def test_dependencies_have_cross_platform_hash_locks(self):
        ...
        self.assertIn("id-token: write", package_workflow)
        self.assertIn("attestations: write", package_workflow)
        self.assertIn("artifact-metadata: write", package_workflow)
        ...
        self.assertNotIn("actions/download-artifact@v", package_workflow)
        self.assertNotIn("actions/attest@v", package_workflow)
        self.assertNotIn("anchore/sbom-action@v", package_workflow)
        ...
        self.assertIn("actions/download-artifact@3e5f45b2", package_workflow)
        self.assertIn("actions/attest@1e69f48a", package_workflow)
        self.assertIn("anchore/sbom-action@e22c3899", package_workflow)
